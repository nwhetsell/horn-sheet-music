...
\relative {
  ...
  \repeat volta 2 {
    \acciaccatura d''8 \tuplet 3/2 8 { c16-. \p #(make-music 'CrescendoEvent 'span-direction START 'span-type 'text 'tweaks '((dash-period . -1))) b-. c-. g-. \< a-. b( c) b-. c( e) d-. c-.} |
    ...
    \acciaccatura f8 \tuplet 3/2 8 {
      e16-. \tweak X-offset #-1.5 \f d-. e-. c( d) e-. f( e) f-. a( \tag #'1st-edition { f) d } \tag #'gumpert { g) f } -. |
    ...
    g'8 \tuplet 3/2 8 { b-flat16( \mf a) g-. d'( b-flat) g-. \tweak NoteColumn.X-offset #0.5 e-flat'( c) g-. } |
    \tuplet 3/2 8 {
    ...
    f'8 \tuplet 3/2 8 { f16( \f d) b-flat-. g'-\tag #'non-gumpert ( f-\tag #'non-gumpert ) g-.
      \tag #'1st-edition { a-flat f d } \tag #'gumpert { a' g f }
    } |
    \tuplet 3/2 8 { e-flat16( d) e-flat-. g f e-flat d( c) d-\tag #'non-gumpert -. \tag #'1st-edition { b-flat c } \tag #'gumpert { f e-flat } d } |
    ...
    <<
      {
        \tuplet 3/2 8 { c16 \p #(make-music 'CrescendoEvent 'span-direction START 'span-type 'text 'tweaks '((dash-period . -1))) b c g \< a b( c) b-. c( e) d c } |
        \tuplet 3/2 8 { g16 \f a b c g e g e c } g8\fermata |
      }
      \tag #'non-gumpert {
        \tuplet 3/2 8 { s16-. s-. s-. s-. s-. s s s s s s-. s-. } |
        \tuplet 3/2 8 { s16-. s-. s-. s-. s-. s-. s-. s-. s-. }
      }
    >>
