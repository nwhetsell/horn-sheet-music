...
\book {
  \score {
    \header { piece = "1" }
    \new Staff <<
      \new Voice { \include "kling-01.ly" }
      #(if preserve-line-breaks? #{ \new Voice { \include "line-breaks/kling-01-line-breaks.ily" } #})
    >>
  }
  ...
  \score {
    \header { piece = "3" }
    \new Staff <<
      \new Voice { \include "kling-03.ly" }
      #(if preserve-line-breaks? #{ \new Voice { \include "line-breaks/kling-03-line-breaks.ily" } #})
    >>
  }
  ...
  \score {
    \header { piece = "4" }
    \new Staff <<
      \new Voice { \include "kling-04.ly" }
      #(if preserve-line-breaks? #{ \new Voice { \include "line-breaks/kling-04-line-breaks.ily" } #})
    >>
  }
  ...
  \score {
    ...
    \new Staff <<
      ...
      #(if preserve-line-breaks? #{ \new Voice { \include "line-breaks/kling-06-line-breaks.ily" } #})
    >>
  }
